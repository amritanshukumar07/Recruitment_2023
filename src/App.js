          ...
          <section id="section-2" style={{ background: "white" }}>
            <div className="about">
              <p className="about-head heading ">
                About{" "}
                <span style={{ color: "#EDA177" }}> E-Cell NIT Bhopal</span>
              </p>
              <p className="about-text">
                ...
                and sessions from experts in respective fields that have laid
                out the foundation for moulding the burgeoning entrepreneurial
                minds.
              </p>
              <a href="#section-form">
                <button
            ...
            <VerticalTimeline className="vertical-timeline">
              ...
              >
                <div style={{ color: "rgb(48 48 48)" }}>
                  ...
                  <p>
                    Tasks are allotted to each vertical to be completed in a
                    fixed duration of a time interval. Round 1 tasks are to be
                    submitted online through google forms.
                  </p>
                </div>
              </VerticalTimelineElement>
              <VerticalTimelineElement
              ...
              >
                <div style={{ color: "rgb(48 48 48)" }}>
                  ...
                  <p>
                    After qualification of the first round, offline interviews
                    are organized by the team E-Cell to test the prompt skills
                    of candidates, management, and ability to deal with work
                    under pressure with tasks and situations allotted at hand.
                  </p>
                </div>
              </VerticalTimelineElement>
              <VerticalTimelineElement
              ...
              >
                <div style={{ color: "rgb(48 48 48)" }}>
                  ...
                  <p>
                    Qualifiers from round 2 are put to the final test with the
                    HR Interview rounds conducted offline. Dedication and
                    perseverance to take society and its events to their highest
                    potential are examined for the final selections.
                  </p>
                </div>
              </VerticalTimelineElement>
              {/* <VerticalTimelineElement
            ...
            <div className="proposal">
              ...
              <div className="proposal-row1">
                <div className="proposal-box wow animate__animated animate__fadeIn">
                  ...
                  <p className="box-text-2">
                    ...
                    programs. They work closely with all other members to
                    identify potential sponsors and develop sponsorship packages
                    that meet the needs of both the parties. They also handle
                    identifying potential sponsors and developing a list of
                    target organizations, developing and pitching sponsorship
                    packages to potential sponsors and negotiating sponsorship
                ...
                <div className="proposal-box wow animate__animated animate__fadeIn">
                  ...
                  <p className="box-text-2">
                    ...
                    well-planned and well-promoted. Their roles include
                    developing and executing a comprehensive public relations
                    strategy, maintaining relationships with key stakeholders
                    including managing social media handles, promotional
                    activities, managing press releases and planning the various
                ...
                <div className="proposal-box wow animate__animated animate__fadeIn">
                  ...
                  <p className="box-text-2">
                    A content writer at E-Cell is responsible for creating
                    written content that supports the team's communication goals
                    and objectives. This includes writing content for the
                    website, social media channels, emails, letters, brochures,
                    press releases and other communication channels. Content
                    writers work closely with members from all other verticals
                    to ensure that apt content is delivered to the targeted
                    audience.
                  </p>
                </div>
              </div>
              <div className="proposal-row2">
                <div className="proposal-box wow animate__animated animate__fadeIn">
                  ...
                  <p className="box-text-2">
                    Designers at team E-Cell are responsible for designing all
                    the posters that are uploaded on the website or social media
                ...
                <div className="proposal-box wow animate__animated animate__fadeIn">
                  ...
                  <p className="box-text-2">
                    ...
                    developing and maintaining the websites of various events
                    and the official website of E-Cell. They work closely with
                    other members, such as the content writing team and the
                    designers to ensure that the website meets our goals and
                    objectives.
                  </p>
                </div>
              </div>
              ...
              <Grid item xs={10} sm={9} md={8} lg={5}>
                ...
                <form
                  ...
                  onSubmit={(e) => {
                    ...
                    var request = axios
                      .post(
                        "https://recruitment-manager-backend.onrender.com/create",
                        txtData
                      )
                      .then(function (response) {
                        if (response.data == 2) {
                          ...
                          const errCodes = {
                            ...
                            0: "PLEASE TRY AGAIN & CONTACT SHRISH SHRIVASTAVA (9340399137)",
                          };
                          if (errCodes[response.data.toString()] == undefined) {
                            toast.error(
                              `FAILED: PLEASE TRY AGAIN & CONTACT SHRISH SHRIVASTAVA (9340399137)`,
                              {
                                position: "bottom-right",
                                autoClose: 5000,
                                hideProgressBar: false,
                            ...
                            toast.error(
                              `ERROR: ${errCodes[response.data.toString()]}`,
                              {
                                position: "bottom-right",
                                autoClose: 5000,
                                hideProgressBar: false,
                      ...
                      .catch(function (error) {
                        toast.error(
                          `ERROR: ${error}, PLEASE TRY AGAIN & CONTACT SHRISH SHRIVASTAVA (9340399137)`,
                          {
                            position: "bottom-right",
                            autoClose: 5000,
                            hideProgressBar: false,
                ...
                >
                  ...
                  >
                    ...
                    <Typography
                      ...
                      gutterBottom
                    >
                      By Clicking Apply you comply with our Rules and
                      Regulations
                    </Typography>
          ...
          <section id="section-6">
            ...
            <div className="faq">
              ...
              <p className="ans">
                ...
                given a task according to their verticals. Participants who
                clear this round shall advance to the offline interview round.
                The participants who advance the offline interview round shall
                face an HR interview round.
              </p>
              <p className="ans">
